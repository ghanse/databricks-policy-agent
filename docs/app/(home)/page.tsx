...
export default function HomePage() {
  return (
    <main className="flex flex-1 flex-col justify-center text-center px-4 py-16">
      <h1 className="mb-4 text-4xl tracking-tight">Databricks Policy Agent</h1>
      <p className="mb-2 max-w-2xl mx-auto text-fd-muted-foreground">
        Declare allow and deny policies over your Databricks workspace objects, scan for
        compliance, and drive violations to resolution.
      </p>
      <br />
      <div className="flex justify-center gap-3">
        ...
        <Link
          href="https://github.com/ghanse/databricks-policy-agent"
